...
<div id="sod_addr" class="new_win">
    ...
    <div class="tbl_head03 tbl_wrap">
        ...
        <tr>
            ...
            <td class="td_address">
                <div class="td_mng">
                <input type="text" name="ad_subject[<?php echo $i; ?>]" id="ad_subject<?php echo $i;?>" class="frm_input" size="12" maxlength="20" value="<?php echo get_text($row['ad_subject']); ?>" placeholder="배송지명">
                </div>
