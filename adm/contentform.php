    ...
    <div class="tbl_frm01 tbl_wrap">
        <table>
            ...
            <tbody>
                ...
                <tr>
                    <th scope="row"><label for="co_level">접근 권한</label></th>
                    <td>
                        <?php echo help('권한 1은 비회원, 2 이상 회원입니다. 권한은 10 이 가장 높습니다.') ?>
                        <?php echo get_member_level_select('co_level', 1, $member['mb_level'], $co['co_level']) ?>
                        
                        <select id="co_level_opt" name="co_level_opt">
                        <option value="1" <?php if (isset($co['co_level_opt']) && $co['co_level_opt'] == "1") { ?>selected<?php } ?>>레벨 부터 접근가능</option>
                        <option value="2" <?php if (isset($co['co_level_opt']) && $co['co_level_opt'] == "2") { ?>selected<?php } ?>>레벨만 접근가능</option>
                        </select>
                    </td>
                </tr>
