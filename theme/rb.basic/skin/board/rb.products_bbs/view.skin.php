...
<div class="rb_bbs_wrap" style="width:<?php echo $width; ?>">
    ...
    <div class="bbs_sv_wrap">
        ...
        <ul class="bbs_sv_wrap_ul2">
            ...
            <div class="gap_btm_bd">
                ...
                <ul class="view_info_btns">
                    <a href="/bbs/board.php?bo_table=qa" class="view_info_btns_btn1 font-R">문의하기</a>
        ...
        <ul class="bbs_sv_wrap_ul1">
                ...
                if ($v_img_count > 0) {
                    ...
                    for ($i = 0; $i < $v_img_count; $i++) {
						...
						if (isset($view['file'][$i]['view']) && $view['file'][$i]['view']) {
							echo "<li class=\"swiper-slide swiper-slide-pf\">";
							echo get_view_thumbnail($view['file'][$i]['view']);
							
							// [추가] 이미지 위에 겹칠 텍스트 영역
							echo '<div class="view_txt_overlay">';
							echo '  <div class="v_subj">' . get_text($view['wr_subject']) . '</div>'; // 제목
							// wr_6(설명글)이 있다면 출력, 없으면 본문내용(wr_content) 일부 출력 등 원하는 대로 변경 가능
							if(isset($view['wr_6']) && $view['wr_6']) { 
								echo '  <div class="v_desc">' . get_text($view['wr_6']) . '</div>'; 
							}
							echo '</div>';
            ...
            <h2 id="" class="mo_pd_none detail_tit">시공내용</h2>
