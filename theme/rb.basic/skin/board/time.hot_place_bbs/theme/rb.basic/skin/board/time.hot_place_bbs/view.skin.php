...
<div class="rb_bbs_wrap" style="width:<?php echo $width; ?>">
    ...
    <div class="bbs_sv_wrap">
        ...
        <div class="rc_wrap1">
            ...
            <ul class="rc_wrap1_ul3 font-B"><?php echo isset($view['wr_8']) ? nl2br($view['wr_8']) : ''; ?></ul>
            <?php } ?>
            
            <?php if(isset($view['wr_6']) && $view['wr_6']) { ?>
            <ul class="rc_wrap1_ul3"><?php echo isset($view['wr_6']) ? nl2br($view['wr_6']) : ''; ?></ul>
            <?php } ?>            
        </div>
                  <!--  추천 비추천 시작 { -->
        ...
        <h1 class="rc_sub_title">업체 상세 정보</h1>
        <div class="rc_wrap2">
            <div class="rc_wrap2_div">
                <ul>
                    <dt>상호명</dt>
                    <dd>
                        <?php if(isset($view['wr_subject']) && $view['wr_subject']) { ?><?php echo isset($view['wr_subject']) ? nl2br($view['wr_subject']) : ''; ?></ul>
                        <?php } ?>
                    </dd>
                </ul>                
                <ul>
                    <dt>도로명주소</dt>
                    <dd>
                        <?php if (isset($view['wr_3']) && $view['wr_3']) { ?><?php $wr_3 = isset($view['wr_3']) ? explode('|', $view['wr_3']) : ['',''];  ?><?php echo nl2br($wr_3[0]); ?> <?php echo nl2br($wr_3[1]); ?></ul>
                        <?php } ?>
                    </dd>
                </ul>
                <ul>
                    <dt>전화번호</dt>
                    <dd>
                        <?php if (isset($view['wr_30']) && $view['wr_30']) { ?>
                            <a href="tel:<?php echo htmlspecialchars($view['wr_30'], ENT_QUOTES, 'UTF-8'); ?>" class="rc_pri_txt font-B">
                                <?php echo htmlspecialchars($view['wr_30'], ENT_QUOTES, 'UTF-8'); ?>
                            </a>
                        <?php } else { ?>
                            비공개
                        <?php } ?>
            ...
            <div class="rc_wrap2_div">
                <ul>
                    <dt>영업상태</dt>
                        ...
                        <?php if(isset($wr_4[1]) && $wr_4[1]) { ?><span class="rc_pri_ico"><?php echo isset($wr_4[1]) ? $wr_4[1] : ''; ?></span><?php } ?>
                        <?php if(isset($wr_4[0]) && $wr_4[0]) { ?><span class="rc_pri_txt font-B"><?php echo isset($wr_4[0]) ? $wr_4[0] : ''; ?></span><?php } else {  ?>미정<?php } ?>
                    </dd>
                </ul>
                <ul>
                    <dt>업종분류</dt>
                    <dd>
                        <?php if(isset($view['ca_name']) && $view['ca_name']) { ?><?php echo isset($view['ca_name']) ? nl2br($view['ca_name']) : ''; ?></ul>
                        <?php } ?>
                    </dd>
                </ul>          
                <ul>
                    <dt>영업시간</dt>
                    <dd>
                        <?php if(isset($wr_5[1]) && $wr_5[1]) { ?><span class="rc_pri_ico"><?php echo isset($wr_5[1]) ? $wr_5[1] : ''; ?></span><?php } ?>
                        <?php if(isset($wr_5[0]) && $wr_5[0]) { ?><span class="rc_pri_txt font-B"><?php echo isset($wr_5[0]) ? $wr_5[0] : ''; ?></span><?php } else {  ?>미정<?php } ?>
                    </dd>
                </ul>       
            </div>
        ...
        <div class="rc_wrap3">
                    ...
                    */
                    ...
                    <span class="rc_sub_title2 font-R"><?php echo isset($wr_3[0]) ? $view['wr_subject'] : ''; ?> <?php echo isset($wr_3[1]) ? $view['wr_subject'] : ''; ?></span>
        ...
        <!-- 기존 { -->
            ...
            <p class="info_btm_bg">본 정보는 등록자가 제공한 자료를 바탕으로 <?php echo isset($config['cf_title']) ? $config['cf_title'] : ''; ?> 에서 편집 및 그 표현방법을 수정하여 완성한 것입니다.<br>본 정보는 <?php echo isset($config['cf_title']) ? $config['cf_title'] : ''; ?>의 동의없이 무단전재 또는 재배포, 재가공할 수 없으며 아쿠아숲 자료이외의 용도로 사용할 수 없습니다.</br> <?php echo isset($config['cf_title']) ? $config['cf_title'] : ''; ?>은(는) 등록자가 게재한 자료에 대한 오류와 사용자가 이를 신뢰하여 취한 조치에 대해 책임을 지지 않습니다.</p>
