...
<div class="rb_bbs_wrap rb_bbs_write_wrap">
    ...
    <div>
        ...
        <div class="rb_inp_wrap">
            <ul>
                <input type="text" name="wr_subject" value="<?php echo $subject ?>" id="wr_subject" required class="input required full_input" maxlength="255" placeholder="업체명을 입력하세요.">
            </ul>
        </div>
        <!-- } -->
        ...
        <div class="rb_inp_wrap new_bbs_border_wrap">
            <ul>
                ...
                <h6 class="bbs_sub_titles font-B">매장위치</h6>
                <label class="helps">매장위치를 입력하세요. 지도로 출력 됩니다.</label>
        ...
        <div class="rb_inp_wrap new_bbs_border_wrap">
            <ul>
                ...
                <h6 class="bbs_sub_titles font-B mb-15">영업형태</h6>

                <li>
                    <input type="radio" id="wr_4_0_1" name="wr_4_ex[0]" value="영업/정상" <?php echo (isset($wr_4[0]) && $wr_4[0] == "영업/정상") ? 'checked' : ''; ?>><label for="wr_4_0_1">영업/정상</label>　
                    <input type="radio" id="wr_4_0_2" name="wr_4_ex[0]" value="영업/종료" <?php echo (isset($wr_4[0]) && $wr_4[0] == "영업/종료") ? 'checked' : ''; ?>><label for="wr_4_0_2">영업/종료</label>　
                    <input type="radio" id="wr_4_0_3" name="wr_4_ex[0]" value="휴업" <?php echo (isset($wr_4[0]) && $wr_4[0] == "휴업") ? 'checked' : ''; ?>><label for="wr_4_0_3">휴업</label>　
                    <input type="radio" id="wr_4_0_4" name="wr_4_ex[0]" value="폐업" <?php echo (isset($wr_4[0]) && $wr_4[0] == "폐업") ? 'checked' : ''; ?>><label for="wr_4_0_4">폐업</label>　
        ...
        <div class="rb_inp_wrap new_bbs_border_wrap">
            <ul>
                ...
                <h6 class="bbs_sub_titles font-B mb-15">영업시간</h6>


                <input type="text" name="wr_5_ex[0]" value="<?php echo isset($wr_5[0]) ? $wr_5[0] : ''; ?>" id="wr_5_0" class="input w30" placeholder="영업시간을 입력하세요.">
        ...
        <div class="rb_inp_wrap new_bbs_border_wrap">
            <ul>
                <h6 class="bbs_sub_titles font-B mb-15">홈페이지 주소</h6>
                <input type="text" name="wr_7" value="<?php echo isset($write['wr_7']) ? $write['wr_7'] : ''; ?>" id="wr_7" class="input w100" placeholder="홈페이지 주소를 입력하세요.">
            </ul>
        </div>
