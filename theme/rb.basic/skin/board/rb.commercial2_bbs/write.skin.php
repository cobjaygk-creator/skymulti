...
<div class="rb_bbs_wrap rb_bbs_write_wrap">
    ...
    <div class="rb_inp_wrap new_bbs_border_wrap">
        <ul>
            ...
            <input type="text" name="wr_1" class="datepicker_inp datepicker_start datepicker" value="<?php echo isset($write['wr_1']) ? $write['wr_1'] : ''; ?>" id="wr_1" placeholder="시작일" required autocomplete="off" readonly>
            <input type="text" name="wr_2" class="datepicker_inp datepicker_end datepicker" value="<?php echo isset($write['wr_2']) ? $write['wr_2'] : ''; ?>" id="wr_2" placeholder="종료일" required autocomplete="off" readonly>　
