...
$wr_4 = isset($write["wr_4"]) ? explode("|", $write["wr_4"]) : [];
$wr_5 = isset($write["wr_5"]) ? explode("|", $write["wr_5"]) : [];
?>
...
<div class="rb_bbs_wrap rb_bbs_write_wrap">
    ...
    <div>
        ...
        <div class="rb_inp_wrap">
            <ul>
                <input type="text" name="wr_8" value="<?php echo isset($write['wr_8']) ?$write['wr_8'] : ''; ?>" id="wr_8" required class="input required full_input w40" placeholder="회사명을 입력하세요.">
            </ul>
        </div>
        <!-- } -->
        ...
        <div class="rb_inp_wrap">
            <ul>
                <textarea name="wr_6" id="wr_6" class="textarea" placeholder="간략 설명을 입력하세요." style="min-height:100px;"><?php echo isset($write['wr_6']) ? $write['wr_6'] : ''; ?></textarea>
            </ul>
        </div>
        ...
        <div class="rb_inp_wrap new_bbs_border_wrap">
            <ul>
                ...
                <h6 class="bbs_sub_titles font-B mb-15">모집기간</h6>

                <li id="dates_inp">
                    <input type="text" name="wr_1_ex[0]" value="<?php echo isset($wr_1[0]) ? $wr_1[0] : ''; ?>" id="wr_1_0" class="input w20 datepicker_inp datepicker" placeholder="시작일">
                    <input type="text" name="wr_1_ex[1]" value="<?php echo isset($wr_1[1]) ? $wr_1[1] : ''; ?>" id="wr_1_1" class="input w20 datepicker_inp datepicker mobile_mt5" placeholder="마감일">
                </li>
                <li class="mt-10">
                    <input type="checkbox" id="wr_1_2" name="wr_1_ex[2]" value="상시모집" <?php echo (isset($wr_1[2]) && $wr_1[2] == "상시모집") ? 'checked' : ''; ?>><label for="wr_1_2">상시모집</label>
                </li>
                
                <script>
                $(document).ready(function() {
                    // 페이지가 로드될 때 초기 상태 설정
                    if ($('#wr_1_2').is(':checked')) {
                        $('#wr_1_0, #wr_1_1').val('').prop('readonly', true).css('opacity', 0.5);
                        $('#dates_inp').hide();
                    }

                    // 체크박스 상태 변경 시 처리
                    $('#wr_1_2').change(function() {
                        if ($(this).is(':checked')) {
                            $('#wr_1_0, #wr_1_1').val('').prop('readonly', true).css('opacity', 0.5);
                            $('#dates_inp').hide();
                        } else {
                            $('#wr_1_0, #wr_1_1').prop('readonly', false).css('opacity', 1);
                            $('#dates_inp').show();
                        }
                    });
                });
        ...
        <div class="rb_inp_wrap new_bbs_border_wrap">
            <ul>
                ...
                <h6 class="bbs_sub_titles font-B mb-15">모집조건</h6>

                <li class="mt-10">
                <input type="text" name="wr_2_ex[0]" value="<?php echo isset($wr_2[0]) ? $wr_2[0] : ''; ?>" id="wr_2_0" class="input w30" placeholder="학력">
                <input type="text" name="wr_2_ex[2]" value="<?php echo isset($wr_2[2]) ? $wr_2[2] : ''; ?>" id="wr_2_2" class="input w15 mobile_mt5" placeholder="연령">
                <input type="text" name="wr_2_ex[3]" value="<?php echo isset($wr_2[3]) ? $wr_2[3] : ''; ?>" id="wr_2_3" class="input w15 mobile_mt5" placeholder="성별">
                <input type="text" name="wr_2_ex[1]" value="<?php echo isset($wr_2[1]) ? $wr_2[1] : ''; ?>" id="wr_2_1" class="input w10 mobile_mt5" placeholder="모집인원">
                </li>
                <li class="mt-10"><input type="text" name="wr_2_ex[4]" value="<?php echo isset($wr_2[4]) ? $wr_2[4] : ''; ?>" id="wr_2_4" class="input w100" placeholder="우대사항"></li>
            </ul>
        </div>
        ...
        <div class="rb_inp_wrap new_bbs_border_wrap">
            <ul>
                ...
                <h6 class="bbs_sub_titles font-B mb-15">고용형태</h6>

                <li>
                    <input type="radio" id="wr_4_0_1" name="wr_4_ex[0]" value="알바" <?php echo (isset($wr_4[0]) && $wr_4[0] == "알바") ? 'checked' : ''; ?>><label for="wr_4_0_1">알바</label>　
                    <input type="radio" id="wr_4_0_2" name="wr_4_ex[0]" value="정규직" <?php echo (isset($wr_4[0]) && $wr_4[0] == "정규직") ? 'checked' : ''; ?>><label for="wr_4_0_2">정규직</label>　
                    <input type="radio" id="wr_4_0_3" name="wr_4_ex[0]" value="계약직" <?php echo (isset($wr_4[0]) && $wr_4[0] == "계약직") ? 'checked' : ''; ?>><label for="wr_4_0_3">계약직</label>　
                    <input type="radio" id="wr_4_0_4" name="wr_4_ex[0]" value="파견직" <?php echo (isset($wr_4[0]) && $wr_4[0] == "파견직") ? 'checked' : ''; ?>><label for="wr_4_0_4">파견직</label>　
                    <input type="radio" id="wr_4_0_5" name="wr_4_ex[0]" value="기타" <?php echo (isset($wr_4[0]) && $wr_4[0] == "기타") ? 'checked' : ''; ?>><label for="wr_4_0_5">기타</label>
                </li>
                
                <li style="display: none;" id="other_input" class="mt-20">
                    <input type="text" name="wr_4_ex[1]" value="<?php echo isset($wr_4[1]) ? $wr_4[1] : ''; ?>" id="wr_4_1" class="input w20" placeholder="직접입력">
                </li>
                
                <script>
                $(document).ready(function() {
                    // 페이지 로드 시 기타가 선택되어 있으면 input을 보이게 설정
                    if ($('input[name="wr_4_ex[0]"]:checked').val() === '기타') {
                        $('#other_input').show();
                    }

                    // radio 버튼 값이 변경될 때 기타가 선택되면 input을 보이게 설정
                    $('input[name="wr_4_ex[0]"]').change(function() {
                        if ($(this).val() === '기타') {
                            $('#other_input').show();
                        } else {
                            $('#other_input').hide();
                            $('input[name="wr_4_ex[1]"]').val('');
                        }
                    });
                });
                </script>
        ...
        <div class="rb_inp_wrap new_bbs_border_wrap">
            <ul>
                ...
                <h6 class="bbs_sub_titles font-B mb-15">급여</h6>


                <input type="text" name="wr_5_ex[0]" value="<?php echo isset($wr_5[0]) ? $wr_5[0] : ''; ?>" id="wr_5_0" class="input w30" placeholder="급여">
                <select name="wr_5_ex[1]" class="select w15 mobile_mt5" id="wr_5_1">
                    <option value="">급여형태</option>
                    <option value="시급" <?php echo (isset($wr_5[1]) && $wr_5[1] == "시급") ? 'selected' : ''; ?>>시급</option>
                    <option value="일급" <?php echo (isset($wr_5[1]) && $wr_5[1] == "일급") ? 'selected' : ''; ?>>일급</option>
                    <option value="주급" <?php echo (isset($wr_5[1]) && $wr_5[1] == "주급") ? 'selected' : ''; ?>>주급</option>
                    <option value="월급" <?php echo (isset($wr_5[1]) && $wr_5[1] == "월급") ? 'selected' : ''; ?>>월급</option>
                    <option value="연봉" <?php echo (isset($wr_5[1]) && $wr_5[1] == "연봉") ? 'selected' : ''; ?>>연봉</option>
                    <option value="기타" <?php echo (isset($wr_5[1]) && $wr_5[1] == "기타") ? 'selected' : ''; ?>>기타</option>
                </select>
        ...
        <div class="rb_inp_wrap new_bbs_border_wrap">
            <ul>
                <h6 class="bbs_sub_titles font-B mb-15">지원방법</h6>
                <input type="text" name="wr_7" value="<?php echo isset($write['wr_7']) ? $write['wr_7'] : ''; ?>" id="wr_7" class="input w100" placeholder="지원방법">
            </ul>
        </div>
...
<div class="rb_bbs_wrap rb_bbs_write_wrap">
    ...
    <h2 id="container_title" class="mt-30">상세요강</h2>
