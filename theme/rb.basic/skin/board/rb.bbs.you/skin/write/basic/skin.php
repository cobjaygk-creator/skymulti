...
?>
    ...
    <!-- wr_1, wr_2 : 유튜브/쇼츠 링크 { -->
    <div class="rb_inp_wrap youtube-link-section" style="display: flex; gap: 16px; align-items: flex-start;">
        <!-- 유튜브 동영상 -->
        <div class="youtube-header" style="flex:1; min-width:0; display:flex; flex-direction:column; gap:8px;">
            <div class="youtube-title">
                <h6 class="bbs_sub_titles font-B">유튜브 동영상 추가</h6>
            </div>
            <p class="youtube-desc" style="margin:0 0 4px 0; color:#888; font-size:13px;">유튜브 링크를 입력하면 동영상이 게시글에 포함됩니다</p>
            <div class="youtube-input-container">
                <div class="input-wrapper">
                    <input type="text" name="wr_1" value="<?php echo isset($write['wr_1']) ? $write['wr_1'] : ''; ?>" id="wr_1" class="youtube-input" placeholder="https://www.youtube.com/watch?v=...">
                </div>
            </div>
        </div>
        <!-- 유튜브 쇼츠 -->
        <div class="youtube-header" style="flex:1; min-width:0; display:flex; flex-direction:column; gap:8px;">
            <div class="youtube-title">
                <h6 class="bbs_sub_titles font-B">유튜브 쇼츠 동영상 추가</h6>
            </div>
            <p class="youtube-desc" style="margin:0 0 4px 0; color:#888; font-size:13px;">유튜브 쇼츠 링크를 입력하면 동영상이 게시글에 포함됩니다</p>
            <div class="youtube-input-container">
                <div class="input-wrapper">
                    <input type="text" name="wr_2" value="<?php echo isset($write['wr_2']) ? $write['wr_2'] : ''; ?>" id="wr_2" class="youtube-input" placeholder="https://youtube.com/shorts/...">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="rb_inp_wrap">
        <ul class="guest_inp_wrap">
            ...
            <lebel class="help_text">익명으로 사용하실 닉네임을 입력하세요.</lebel>
            <li>
                
                <input type="text" name="wr_name" value="<?php echo $name ?>" id="wr_name" required class="input_tiny required" placeholder="이름(닉네임)">
                ...
                <button type="button" id="nickname-suggest-btn">닉네임추천</button>
                <script>
                let nicknameList = [];

                function loadNicknames() {
                    fetch('<?php echo $board_skin_url ?>/nickname_list.txt') //닉네임 추천 단어파일 입니다. 기본 50개가 들어있습니다.
                ...
                document.addEventListener("DOMContentLoaded", function () {
                    ...
                    document.getElementById('nickname-suggest-btn').addEventListener('click', function () {
...
<script>
// 외부 라이브러리(jQuery, Swiper) 체크 및 안내
if (typeof $ === 'undefined') {
    alert('jQuery 라이브러리가 로드되지 않았습니다. 일부 기능이 정상 동작하지 않을 수 있습니다.');
}
if (typeof Swiper === 'undefined') {
    alert('Swiper 라이브러리가 로드되지 않았습니다. 파일 첨부, 카테고리 슬라이드 등 일부 기능이 제한됩니다.');
}
</script>
...
<script>
document.addEventListener('DOMContentLoaded', function() {
    var youtubeInput = document.getElementById('wr_1');
