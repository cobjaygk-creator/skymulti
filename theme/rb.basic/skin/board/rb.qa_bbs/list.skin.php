...
<div class="rb_bbs_wrap" id="scroll_container" style="width:<?php echo $width; ?>">
    ...
    <ul class="rb_bbs_top">
		...
		<li class="cnts" style="font-size:15px;">홈페이지 개편으로 이전 문의사항은 지원하지 않습니다. 신규로 문의 부탁드리겠습니다.</li>
                ...
                <table class="rb-board-table">
                    ...
                    <tbody>
                        ...
                        <tr>
							...
							<td class="rb-board-qa">
								<?php
								$comment_count = isset($list[$i]['wr_comment']) ? $list[$i]['wr_comment'] : 0;

								if ($comment_count > 0) {
									echo '<span class="reply_done">답변완료</span> ';
								} else {
									echo '<span class="reply_waiting">답변대기</span> ';
								}
								?>
							</td>
							...
							<a href="<?php echo $list[$i]['href'] ?>" class="font-R">
