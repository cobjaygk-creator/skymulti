        ...
        <tr>
            ...
            <td colspan="2">
                <div class="sit_option tbl_frm01">
                    ...
                    <tr>
                        <th scope="row">
                            <input type="text" name="opt1_subject" value="<?php echo isset($opt_subject[0]) ? $opt_subject[0] : ''; ?>" id="opt1_subject" class="frm_input" size="15" placeholder="옵션1 제목">
                        </th>
                        <td>
                            <input type="text" name="opt1" value="" id="opt1" class="frm_input" size="50" placeholder="옵션1 항목 : 콤마(,)구분 복수입력 가능">
                        </td>
                    </tr>
                    <tr>
                        <th scope="row">
                            <input type="text" name="opt2_subject" value="<?php echo isset($opt_subject[1]) ? $opt_subject[1] : ''; ?>" id="opt2_subject" class="frm_input" size="15" placeholder="옵션2 제목">
                        </th>
                        <td>
                            <input type="text" name="opt2" value="" id="opt2" class="frm_input" size="50" placeholder="옵션2 항목 : 콤마(,)구분 복수입력 가능">
                        </td>
                    </tr>
                     <tr>
                        <th scope="row">
                            <input type="text" name="opt3_subject" value="<?php echo isset($opt_subject[2]) ? $opt_subject[2] : ''; ?>" id="opt3_subject" class="frm_input" size="15" placeholder="옵션3 제목">
                        </th>
                        <td>
                            <input type="text" name="opt3" value="" id="opt3" class="frm_input" size="50" placeholder="옵션3 항목 : 콤마(,)구분 복수입력 가능">
                        </td>
                    </tr>
                    </tbody>
                    </table>
                ...
                <div id="sit_supply_frm" class="sit_option tbl_frm01">
                    ...
                    <tr>
                        <th scope="row">
                            ...
                            <input type="text" name="spl_subject[]" id="spl_subject_<?php echo $seq; ?>" value="<?php echo $spl_subject[$i]; ?>" class="frm_input" size="15" placeholder="추가옵션 제목">
                        </th>
                        <td>
                            <input type="text" name="spl[]" id="spl_item_<?php echo $seq; ?>" value="" class="frm_input" size="40" placeholder="추가옵션 항목 : 콤마(,)구분 복수입력 가능">
                            <?php
                            if($i > 0)
