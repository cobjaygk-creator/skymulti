...
<div class="tbl_head01 tbl_wrap tbl_pa_list tbl_pa_list_order" id="itemuselist">
    ...
    <tr class="<?php echo $bg; ?>">
        ...
        <td class="td_mng td_mng_s">
            <a href="./partner.php?w=u&amp;is_id=<?php echo $row['is_id']; ?>&amp;<?php echo $qstr; ?>&amp;sub=useform" class="btn btn_03"><span class="sound_only"><?php echo get_text($row['is_subject']); ?> </span>답변</a>
        </td>
    </tr>
