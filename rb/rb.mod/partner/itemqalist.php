...
<?php if(isset($main_qa) && $main_qa == "true") { ?>
<?php } else { ?>
...
<div class="tbl_head01 tbl_wrap tbl_pa_list tbl_pa_list_order" id="itemqalist" <?php if(isset($main_qa) && $main_qa == "true") { ?>style="padding-top:15px;"<?php } ?>>
    <table>
    ...
    <tr class="<?php echo $bg; ?>">
        ...
        <td class="td_left" <?php if(isset($main_qa) && $main_qa == "true") { ?>style="width:60%;"<?php } else { ?>style="width:30%;"<?php } ?>>
            <a href="<?php if(isset($main_qa) && $main_qa == "true") { ?><?php echo G5_URL ?>/rb/partner.php?main=qa&sub=qalist<?php } else { ?>javascript:void(0);<?php } ?>" class="qa_href font-B cut" <?php if(isset($main_qa) && $main_qa == "true") { ?><?php } else { ?>onclick="return false;" target="<?php echo $i; ?>"<?php } ?>><?php echo get_text($row['iq_subject']); ?></a>
        </td>
        <td class="td_name" nowrap><?php echo $name; ?></td>
        <td class="td_boolean" nowrap><?php echo $answer; ?></td>
        <?php if(isset($main_qa) && $main_qa == "true") { ?>
        <?php } else { ?>
    ...
    if ($i == 0) {
        if(isset($main_qa) && $main_qa == "true") {
            echo '<tr><td colspan="3" class="empty_table"><span>자료가 없습니다.</span></td></tr>';
        } else { 
