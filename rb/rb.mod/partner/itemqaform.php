...
$iq_question = get_view_thumbnail(conv_content($iq['iq_question'], 1), 200);
...
<form name="fitemqaform" method="post" action="./rb.mod/partner/itemqaformupdate.php" onsubmit="return fitemqaform_submit(this);">
...
<div class="local_desc02 local_desc mt-20">
    <p>상품에 대한 문의에 답변하실 수 있습니다.<br>답변 완료시 작성자에게 답변완료 알림이 발송 됩니다.</p>
</div>
...
<div class="btn_fixed_top">
    <a href="./partner.php?<?php echo $qstr; ?>&amp;sub=qalist" class="btn btn_02">목록</a>
