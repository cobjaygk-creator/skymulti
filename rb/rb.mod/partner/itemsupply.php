...
<div class="sit_option_frm_wrapper tbl_pa_list">
    ...
    <tr>
        <th scope="col">
            ...
            <input type="checkbox" name="spl_chk_all" value="1" id="spl_chk_all">
            <label for="spl_chk_all"></label>
        </th>
        <th scope="col">옵션명</th>
    ...
    <tr>
        <td class="td_chk">
            ...
            <label for="spl_chk_<?php echo $i; ?>"></label>
        </td>
        ...
        <td class="td_mng">
            <select name="spl_use[]" id="spl_use_<?php echo $i; ?>" class="select">
    ...
    <?php
        ...
        <tr>
            <td class="td_chk">
                ...
                <input type="checkbox" name="spl_chk[]" id="spl_chk_<?php echo $i . '_' . $j; ?>" value="1">
                <label for="spl_chk_<?php echo $i . '_' . $j; ?>"></label>
            </td>
            <td class="spl-subject-cell"><?php echo get_text($spl_subject); ?></td>
            <td class="spl-cell"><?php echo $spl; ?></td>
            <td class="td_numsmall">
                <input type="text" name="spl_price[]" value="<?php echo $spl_price; ?>" id="spl_price_<?php echo $i . '_' . $j; ?>" class="frm_input" size="9">
            </td>
            <td class="td_num">
                <input type="text" name="spl_stock_qty[]" value="<?php echo $spl_stock_qty; ?>" id="spl_stock_qty_<?php echo $i . '_' . $j; ?>" class="frm_input" size="5">
            </td>
            <td class="td_num">
                <input type="text" name="spl_noti_qty[]" value="<?php echo $spl_noti_qty; ?>" id="spl_noti_qty_<?php echo $i . '_' . $j; ?>" class="frm_input" size="5">
            </td>
            <td class="td_mng">
                <select name="spl_use[]" id="spl_use_<?php echo $i . '_' . $j; ?>" class="select">
                    <option value="1" <?php echo get_selected('1', $spl_use); ?>>사용함</option>
                    <option value="0" <?php echo get_selected('0', $spl_use); ?>>사용안함</option>
                </select>
            </td>
...
<fieldset>
    ...
    <select name="spl_com_use" id="spl_com_use" class="select">
